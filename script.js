...
function setLanguage(lang) {
  ...
  for (const [id, text] of Object.entries(textElements)) {
    ...
    if (element) {
      if (id === 'about' || id === 'project1-description' || id === 'project2-description' || 
          id === 'project3-description' || id === 'project4-description' || 
          id === 'project1-skills' || id === 'project2-skills' || 
          id === 'project3-skills' || id === 'project4-skills') {
  ...
  document.querySelector('.project-image a[href="photos/3Rw.jpeg"]').setAttribute('data-title', 
    `${langContent.project4Title} - ${langContent.myProjects}`);
